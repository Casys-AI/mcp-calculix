...
Release `0.8.6` publishes to JSR and as a multi-architecture image for
...
`ghcr.io/casys-ai/mcp-calculix:0.8.6` is a mutable discovery tag, not a
...
```bash
deno run --allow-all jsr:@casys/mcp-calculix@0.8.6/server --stdio
```
